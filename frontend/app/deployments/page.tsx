    ...
    <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 pb-24 transition-colors duration-200 sm:px-8 lg:gap-20 lg:px-16">
      <div className="pointer-events-none fixed inset-0 -z-10">
        ...
        <section className="space-y-4 transition-colors duration-200">
          ...
          <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.3em] text-muted-foreground sm:text-xs">
            <span className="rounded-full border border-border dark:border-white/15 px-3 py-1">Auto-refresh 30s</span>
            <span className="rounded-full border border-border dark:border-white/15 px-3 py-1">Explorer Deep Links</span>
            <span className="rounded-full border border-border dark:border-white/15 px-3 py-1">Analyze via Gemini 2.5</span>
          </div>
